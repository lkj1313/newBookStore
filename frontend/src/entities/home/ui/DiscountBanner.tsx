...
const DiscountBanner = () => {
  return (
    <div className="w-full h-36 mt-20 bg-green-100 dark:bg-gray-800 ml-0 flex items-center justify-center">
      <div className=" h-full p-1 flex gap-3  sm:w-3/5 sm:justify-between">
        <div className="text-xs font-bold dark:text-gray-300 grow-1 flex flex-col justify-center sm:text-xl sm:w-1/2">
