const Footer = () => {
  return (
    <footer className="flex justify-center items-center h-36 w-full bg-gray-100  dark:bg-gray-800">
      <div className="flex justify-between text-xs gap-2 text-black dark:text-white font-serif sm:w-1/2">
        <div className="text-xs sm:text-base">@L서점 - 2024</div>
        <div className="text-xs sm:text-base">Privacy Policy FAQ</div>
        <div className="flex gap-1 sm:gap-2">
          ...
          >
            <svg
              className="w-4 h-4 sm:w-6 sm:h-6" // 반응형 크기 설정
              viewBox="0 0 18 19"
              fill="none"
          ...
          >
            <svg
              className="w-4 h-4 sm:w-6 sm:h-6 fill-black dark:fill-white" // 반응형 크기 설정 및 Dark Mode 설정
              viewBox="0 0 20 20"
              fill=""
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clipPath="url(#clip0_37732_414)">
                <path
